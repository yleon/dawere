class DawMateAcadsController < ApplicationController
  ...
  private
    ...
    def daw_mate_acad_params
      params.require(:daw_mate_acads).permit(:mac_nombre, :mac_descripcion, :mac_archivo, :mac_disponible, :mac_estado, :mac_url, :mac_tipo, :mac_palabsclave, :daw_prof_asist_id)
    end
end
