...
class DawCodigosControllerTest < ActionController::TestCase
  ...
  test "should create daw_codigo" do
    assert_difference('DawCodigo.count') do
      post :create, daw_codigo: { cod_estado: @daw_codigo.cod_estado, cod_valor: @daw_codigo.cod_valor, daw_promo_id: @daw_codigo.daw_promo_id }
    end
  ...
  test "should update daw_codigo" do
    patch :update, id: @daw_codigo, daw_codigo: { cod_estado: @daw_codigo.cod_estado, cod_valor: @daw_codigo.cod_valor, daw_promo_id: @daw_codigo.daw_promo_id }
    assert_redirected_to daw_codigo_path(assigns(:daw_codigo))
  end
