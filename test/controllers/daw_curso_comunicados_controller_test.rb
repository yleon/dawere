...
class DawCursoComunicadosControllerTest < ActionController::TestCase
  ...
  test "should create daw_curso_comunicado" do
    assert_difference('DawCursoComunicado.count') do
      post :create, daw_curso_comunicado: { cur_com_fechaenviado: @daw_curso_comunicado.cur_com_fechaenviado, daw_comunicado_id: @daw_curso_comunicado.daw_comunicado_id }
    end
  ...
  test "should update daw_curso_comunicado" do
    patch :update, id: @daw_curso_comunicado, daw_curso_comunicado: { cur_com_fechaenviado: @daw_curso_comunicado.cur_com_fechaenviado, daw_comunicado_id: @daw_curso_comunicado.daw_comunicado_id }
    assert_redirected_to daw_curso_comunicado_path(assigns(:daw_curso_comunicado))
  end
